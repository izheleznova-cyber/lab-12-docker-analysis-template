...
Сначала нужно поиграть, чтобы получить лог. Запускайте игру в Python  на своем компьютере (не в Docker!):
Сегодня задание: провести своего "героя-колобка" по кратчайшей траектории туда и обратно, получить лог в своем репозитории на локальном компьютере
```bash
python3 game.py
